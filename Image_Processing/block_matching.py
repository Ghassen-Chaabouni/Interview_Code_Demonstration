...
def segmentImage(anchor, blockSize):
    """
...
def blockSearchBody(anchor, target, blockSize, searchArea):
    """
...
def main(anchorFrame, targetFrame, outfile, saveOutput, blockSize, searchArea):
    """
    ...
    predictedFrame = blockSearchBody(anchorFrame, targetFrame, blockSize,searchArea)
    ...
    cv2.imwrite("Residual.png", residualFrame)
    cv2.imwrite("Predicted.png", residualFrame)
